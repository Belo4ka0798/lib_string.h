...
START_TEST(s21_strcat_test_1) {
    ...
    char *s2 = "1234sfgddngh";
    ck_assert_pstr_eq(strcat(s1, s2), s21_strcat(s3, s2));
} END_TEST

START_TEST(s21_strcat_test_2) {
    char s1[255] = "QWERTYuiopasdfgh";
    char s3[255] = "QWERTYuiopasdfgh";
...
START_TEST(s21_strcat_test_5) {
    char s1[255] = "QWERTY3243rre";
    char s3[255] = "QWERTY3243rre";
...
START_TEST(s21_strncpy_test_1) {
    ...
    char s3[255] = "QWERTY";
    char s2[255] = "Eeee";
    ck_assert_pstr_eq(strncpy(s3, s2, 2), s21_strncpy(s1, s2, 2));
} END_TEST
...
Suite *s21_string_a_suite(void) {
    ...
    tcase_add_test(string_a_case, s21_strcat_test_2);
    tcase_add_test(string_a_case, s21_strcat_test_3);
    tcase_add_test(string_a_case, s21_strcat_test_4);
    tcase_add_test(string_a_case, s21_strcat_test_5);
    tcase_add_test(string_a_case, s21_strcat_test_6);
    suite_add_tcase(s, string_a_case);
